...
- **Current implementation:** backend-neutral contract, request-scoped provider-core integration, Workers KV, D1, single-root Durable Object SQLite, injected-client PostgreSQL, and single-key scripted Redis
